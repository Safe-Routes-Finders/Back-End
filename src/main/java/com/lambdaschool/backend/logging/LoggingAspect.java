package com.lambdaschool.backend.logging;
...
{
    @Around(value = "@within(com.lambdaschool.backend.logging.Loggable) || @annotation(com.lambdaschool.backend.logging.Loggable)")
